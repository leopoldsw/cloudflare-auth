...
await requireFile(".claude/skills/cf-auth-setup/SKILL.md");
await requireFile("docs/alpha-evidence.example.json");
await requireFile("docs/alpha.md");
await requireFile("docs/architecture.md");
await requireFile("docs/automation.md");
await requireFile("docs/manual-steps.md");
...
await requireFile("schemas/setup-report.schema.json");
await requireFile("templates/hono-basic/AGENTS.md");
await requireFile("templates/worker-basic/AGENTS.md");
await requireFile("templates/react-vite-worker/AGENTS.md");
...
await requireText("docs/alpha.md", "cf-auth setup --report --env production");
